...
import ConjugationGameView from './ConjugationGameView';
      ...
      <div className="text-center space-y-6 max-w-3xl relative">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl xs:text-5xl sm:text-8xl md:text-9xl font-black text-slate-950 tracking-tighter uppercase italic leading-none">
            ԻՍՊԱՆԵՐԵՆ <br/><span className="text-indigo-600">ՄՐՑՈՒՅԹ</span>
          </h1>
      ...
      <div className="w-full max-w-xl space-y-6">
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-6 text-slate-900 text-left">
            ...
            <div className="space-y-1 flex-1">
              <h3 className="text-2xl sm:text-4xl font-black italic uppercase tracking-tighter leading-tight group-hover:text-indigo-600 transition-colors">ԲԱՑԱՏՐՈՒԹՅՈՒՆ</h3>
              <p className="text-slate-400 text-sm sm:text-base font-bold italic leading-tight">Quedar թե՞ Quedarse. սովորիր տարբերությունը:</p>
            </div>
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-6 text-white text-left">
            ...
            <div className="space-y-1 flex-1">
              <h3 className="text-2xl sm:text-4xl font-black italic uppercase tracking-tighter leading-tight group-hover:text-indigo-400 transition-colors">ՄՐՑՈՒՅԹ</h3>
              <p className="text-white/70 text-sm sm:text-base font-bold italic leading-tight">Գոռ և Գայանե, սկսեք ձեր մրցույթը:</p>
            </div>
    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans selection:bg-indigo-100 selection:text-indigo-600 overflow-x-hidden">
      ...
      <main className="relative z-10 w-full min-h-screen">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {screen === 'game' && <ConjugationGameView onBack={() => setScreen('menu')} />}
          </motion.div>
        </AnimatePresence>
      </main>
      ...
      <footer className="px-4 py-24 text-center pb-32">
        <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.5em]">
           &copy; 2026 ԻՍՊԱՆԵՐԵՆԻ ՈՒՍՈՒՑՈՒՄ: QUEDAR VS QUEDARSE
        </p>
      </footer>
    </div>
  );
